...
function sendHeroWhatsapp(event) {
    ...
    var message = "👋 السلام عليكم، أرغب في الاستفسار عن خدمات عزل الخزانات.%0a%0a" +
                  "📌 *فضلاً، زودنا بالبيانات التالية لخدمتك بشكل أسرع:*%0a" +
                  "▪️ *الاسم الكريم:* ....................%0a" +
                  "▪️ *المدينة والحي:* ....................%0a" +
                  "▪️ *نوع الخدمة (عزل/كشف تسربات/نظافة):* ....................%0a" +
        ...
        shareBtn.addEventListener('click', function() {
            if (navigator.share) {
                navigator.share({
                    ...
                    text: 'أنصحك بالتعامل مع شركة الأمانة لعزل الخزانات، خدمة ممتازة!',
